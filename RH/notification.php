...
<div class="content">
        ...
        <div class="mx-n4 mx-lg-n6 mb-5 border-bottom border-300">
          <div class="d-flex align-items-center justify-content-between py-3 border-300 px-lg-6 px-4 notification-card border-top read">
            <div class="d-flex">
              <div class="avatar avatar-xl me-3"><img class="rounded-circle" src="../assets/img/team/30.png" alt="" /></div>
          ...
          <div class="d-flex align-items-center justify-content-between py-3 border-300 px-lg-6 px-4 notification-card border-top unread">
            <div class="d-flex">
              <div class="avatar avatar-xl me-3"><img class="rounded-circle avatar-placeholder" src="../assets/img/team/avatar.png" alt="" /></div>
              <div class="me-3 flex-1 mt-2">
                <h4 class="fs--1 text-black">Jessie Samson</h4>
        ...
        <div class="mx-n4 mx-lg-n6 mb-9 border-bottom border-300">
          <div class="d-flex align-items-center justify-content-between py-3 border-300 px-lg-6 px-4 notification-card border-top unread">
            <div class="d-flex">
              <div class="avatar avatar-xl me-3"><img class="rounded-circle" src="../assets/img/team/57.png" alt="" /></div>
              <div class="me-3 flex-1 mt-2">
          ...
          <div class="d-flex align-items-center justify-content-between py-3 border-300 px-lg-6 px-4 notification-card border-top unread">
            <div class="d-flex">
              <div class="avatar avatar-xl me-3"><img class="rounded-circle" src="../assets/img/team/59.png" alt="" /></div>
              <div class="me-3 flex-1 mt-2">
          ...
          <div class="d-flex align-items-center justify-content-between py-3 border-300 px-lg-6 px-4 notification-card border-top read">
            <div class="d-flex">
              <div class="avatar avatar-xl me-3"><img class="rounded-circle" src="../assets/img/team/58.png" alt="" /></div>
              <div class="me-3 flex-1 mt-2">
          ...
          <div class="d-flex align-items-center justify-content-between py-3 border-300 px-lg-6 px-4 notification-card border-top read">
            <div class="d-flex">
              <div class="avatar avatar-xl me-3"><img class="rounded-circle" src="../assets/img/team/60.png" alt="" /></div>
              <div class="me-3 flex-1 mt-2">
          ...
          <div class="d-flex align-items-center justify-content-between py-3 border-300 px-lg-6 px-4 notification-card border-top read">
            <div class="d-flex">
              <div class="avatar avatar-xl me-3"><img class="rounded-circle" src="../assets/img/team/34.png" alt="" /></div>
              <div class="me-3 flex-1 mt-2">
